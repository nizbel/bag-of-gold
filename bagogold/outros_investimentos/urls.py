...
urlpatterns = [
    ...
    url(r'^inserir-amortizacao/(?P<id_investimento>\d+)/$', views.inserir_amortizacao, name='inserir_amortizacao'),
    url(r'^inserir-investimento/$', views.inserir_investimento, name='inserir_investimento'),
    url(r'^inserir-rendimento/(?P<id_investimento>\d+)/$', views.inserir_rendimento, name='inserir_rendimento'),
