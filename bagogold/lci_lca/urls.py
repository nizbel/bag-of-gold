...
urlpatterns = [
    ...
    url(r'^editar-historico-vencimento/(?P<historico_vencimento_id>\d+)/$', views.editar_historico_vencimento, name='editar_historico_vencimento_lci_lca'),
    url(r'^editar-lci-lca/(?P<lci_lca_id>\d+)/$', views.editar_lci_lca, name='editar_lci_lca'),
    url(r'^editar-operacao/(?P<operacao_id>\d+)/$', views.editar_operacao_lci_lca, name='editar_operacao_lci_lca'),
    ...
    url(r'^inserir-historico-vencimento-lci-lca/(?P<lci_lca_id>\d+)/$', views.inserir_historico_vencimento, name='inserir_historico_vencimento_lci_lca'),
