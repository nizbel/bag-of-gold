...
urlpatterns = [
    ...
    url(r'^inserir-letra-credito/$', views.inserir_lci_lca, name='inserir_lci_lca'),
    url(r'^inserir-operacao-lc/$', views.inserir_operacao_lci_lca, name='inserir_operacao_lci_lca'),
