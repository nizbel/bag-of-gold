...
# Inline FormSet para outros investimentos
class DivisaoInvestimentoFormSet(forms.models.BaseInlineFormSet):
    def __init__(self, *args, **kwargs):
        self.investidor = kwargs.pop('investidor')
        super(DivisaoInvestimentoFormSet, self).__init__(*args, **kwargs)
...
#                 print form_divisao.cleaned_data.get('quantidade')
        ...
        if self.instance.quantidade < qtd_total_div:
            raise forms.ValidationError('Quantidade total alocada para as divisões é maior que quantidade do investimento')
        elif self.instance.quantidade > qtd_total_div:
            if divisao_a_excluir:
                raise forms.ValidationError('Quantidade total alocada para as divisões é menor que quantidade do investimento. Repasse a quantidade da divisão excluída para a(s) remanescente(s)')
            raise forms.ValidationError('Quantidade total alocada para as divisões é menor que quantidade do investimento')
         
# Inline FormSet para operações em criptomoedas
class DivisaoOperacaoCriptomoedaFormSet(forms.models.BaseInlineFormSet):
    def __init__(self, *args, **kwargs):
        self.investidor = kwargs.pop('investidor')
        super(DivisaoOperacaoCriptomoedaFormSet, self).__init__(*args, **kwargs)
...
# Inline FormSet para transferências em criptomoedas
class DivisaoTransferenciaCriptomoedaFormSet(forms.models.BaseInlineFormSet):
    def __init__(self, *args, **kwargs):
        self.investidor = kwargs.pop('investidor')
        super(DivisaoTransferenciaCriptomoedaFormSet, self).__init__(*args, **kwargs)
...
#                 print form_divisao.cleaned_data.get('quantidade')
        ...
        if self.instance.quantidade < qtd_total_div:
            raise forms.ValidationError('Quantidade total alocada para as divisões é maior que quantidade da transferência')
        elif self.instance.quantidade > qtd_total_div:
            if divisao_a_excluir:
