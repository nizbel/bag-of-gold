...
#     url(r'^cadastro/$', registration_views.RegistrationView.as_view(form_class=RegistrationFormUniqueEmail), name='cadastro'),
    ...
    url(r'^gerador_proventos/listar_informacoes_geracao_provento/(?P<tipo_documento>[a-z]+)/$', views.gerador_proventos.gerador_proventos.listar_informacoes_geracao_provento, name='listar_informacoes_geracao_provento'),
