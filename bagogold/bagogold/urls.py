...
#     url(r'^cadastrar/$',  views.investidores.investidores.cadastrar, name='cadastrar'),
    ...
    url(r'^senha_esquecida/$', password_reset, {'template_name': 'registration/reset_senha.html'}, name='password_reset'),
    url(r'^senha_esquecida/sucesso/$', password_reset_done, name='password_reset_done'),
