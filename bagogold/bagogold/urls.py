...
urlpatterns = [
    ...
    url(r'^senha_esquecida/$', password_reset, {'template_name': 'registration/confirmar_redefinir_senha.html', 'email_template_name': 'registration/redefinir_senha_email.html', 'subject_template_name': 'redefinir_senha_email_assunto.txt'}, name='password_reset'),
