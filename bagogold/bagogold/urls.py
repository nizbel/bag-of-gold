...
gerador_proventos_patterns = [
    url(r'^baixar-documento-provento-aws/(?P<id_documento>\d+)/$', views.gerador_proventos.gerador_proventos.baixar_documento_provento, name='baixar_documento_provento'),
