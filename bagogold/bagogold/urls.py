...
#     url(r'^$', views.acoes.buyandhold.listar_acoes, name='listar_acoes'),
    ...
    url(r'^cdb_rdb/modificar_porcentagem_cdb_rdb/$', views.cdb_rdb.cdb_rdb.modificar_porcentagem_cdb_rdb, name='modificar_porcentagem_cdb_rdb'),
    ...
    url(r'^fundo_investimento/modificar_porcentagem_fundo_investimento/$', views.fundo_investimento.fundo_investimento.modificar_porcentagem_fundo_investimento, name='modificar_porcentagem_fundo_investimento'),
