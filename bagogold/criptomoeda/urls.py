...
#     url(r'^detalhar_criptomoeda/(?P<id_criptomoeda>\d+)/$', views.detalhar_criptomoeda, name='detalhar_criptomoeda'),
    ...
    url(r'^inserir_operacao_lote/$', views.inserir_operacao_lote, name='inserir_operacao_criptomoeda_lote'),
    url(r'^inserir_transferencia/$', views.inserir_transferencia, name='inserir_transferencia_criptomoeda'),
    url(r'^inserir_transferencia_lote/$', views.inserir_transferencia_lote, name='inserir_transferencia_criptomoeda_lote'),
